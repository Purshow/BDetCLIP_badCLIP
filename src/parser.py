...
def parse_args():
    ...
    parser.add_argument("--name", type = str, default = "eval_imagenet_1k", help = "Experiment Name")
    ...
    parser.add_argument("--eval_data_type", type = str, default = "ImageNet1K", choices = ["Caltech101", "CIFAR10", "CIFAR100", "DTD", "FGVCAircraft", "Flowers102", "Food101", "GTSRB", "ImageNet1K", "OxfordIIITPet", "RenderedSST2", "StanfordCars", "STL10", "SVHN", "ImageNetSketch", "ImageNetV2", "ImageNet-A", "ImageNet-R"], help = "Test dataset type")
    parser.add_argument("--eval_test_data_csv", type = str, default = None, help = "Path to eval test data")
    parser.add_argument("--eval_test_data_dir", type = str, default = "/home/nyw/datasets/ImageNet1K/ImageNet1K/validation", help = "Path to eval test data")
    ...
    parser.add_argument("--checkpoint", default = "/home/nyw/contrastive_detection/rebuttal_nips/BadCLIP-master/epoch_10.pt", type = str, help = "Path to checkpoint to resume training")
    ...
    parser.add_argument("--asr", default = "True", action = "store_true", help = "Calculate Attack Success Rate (ASR)")
    ...
    parser.add_argument("--add_backdoor", default = True, action = "store_true", help = "add backdoor or not")
    parser.add_argument("--label_consistent", default = False, action = "store_true", help = "add backdoor or not")
    parser.add_argument("--patch_type", default = "ours_tnature", type = str, help = "patch type of backdoor")
    parser.add_argument("--patch_location", default = "middle", type = str, help = "patch location of backdoor")
    ...
    parser.add_argument("--bd_ratio", type = float, default=0.3, help="the proportion of backdoor samples in testing")
    parser.add_argument("--threshold", type = float, default=0.3, help="")

    # optimize_patch
    parser.add_argument("--seed", type=int, help='random seed for data shuffle, default=123', default=123)#tnature_eda_aug_bs64_ep50_64_middle_01_05_pos_neg_tri*500.jpg tnature_eda_bs64_ep50_64_middle_01_05_pos_neg.jpg
    parser.add_argument("--patch_name", type=str, default='/home/nyw/contrastive_detection/rebuttal_nips/BadCLIP-master/BadCLIP-master/opti_patches/tnature_eda_bs64_ep50_64_middle_01_05_pos_neg.jpg')
